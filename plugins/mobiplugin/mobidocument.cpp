...
MobiDocument::MobiDocument(QObject* parent)
  ...
  , d_ptr(new MobiDocumentPrivate(this))
{}
...
MobiDocument::MobiDocument(MobiDocumentPrivate& d)
  : ITextDocument(d.q_ptr)
{}

QString
MobiDocument::buildTocFromData()
{}

Metadata
MobiDocument::metadata()
{}

QString
MobiDocument::filename()
{
  Q_D(MobiDocument);
  return d->filename();
}
...
void
MobiDocument::setFilename(const QString& filename)
{
  Q_D(MobiDocument);
...
void
MobiDocument::saveDocument(const QString& path)
{
  Q_D(MobiDocument);
  d->saveDocument();
}
...
void
MobiDocument::setPlugin(IEBookInterface* plugin)
{
  Q_D(MobiDocument);
  d->setPlugin(plugin);
}
...
QString
MobiDocument::creatorNames(const QStringList&)
{
  Q_D(MobiDocument);
...
void
MobiDocument::setPublished(const QDate& published)
{
  Q_D(MobiDocument);
