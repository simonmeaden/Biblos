...
MobiPlugin::MobiPlugin(QObject* parent)
  : QObject(parent)
{}
...
QString
MobiPlugin::pluginGroup() const
{
  return m_plugin_group;
}

QString
MobiPlugin::pluginName() const
{
  return m_plugin_name;
}

QString
MobiPlugin::vendor() const
{
  return m_vendor;
}

bool
MobiPlugin::loaded() const
{
  return m_loaded;
}

void
MobiPlugin::setLoaded(bool loaded)
{
  m_loaded = loaded;
}

QString
MobiPlugin::version() const
{
  return m_version;
}

int
MobiPlugin::majorVersion() const
{
  return m_major_version;
}

int
MobiPlugin::minorVersion() const
{
  return m_minor_version;
}

int
MobiPlugin::buildVersion() const
{
  return m_build_version;
}

void
MobiPlugin::buildMenu()
{}

EBookDocument
MobiPlugin::createDocument(QString path)
{
  m_document = EBookDocument(new MobiDocument(this));
  m_document->openDocument(path);
  return m_document;
}

EBookDocument
MobiPlugin::createCodeDocument()
{}

QString
MobiPlugin::fileFilter()
{
  return m_file_filter;
}

QString
MobiPlugin::fileDescription()
{
