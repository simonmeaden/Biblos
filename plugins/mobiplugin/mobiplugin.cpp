...
QString MobiPlugin::pluginName() const
{
  return m_plugin_name;
}

QString MobiPlugin::vendor() const
{
  return m_vendor;
}

bool MobiPlugin::loaded() const
{
  return m_loaded;
}

void MobiPlugin::setLoaded(bool loaded)
{
  m_loaded = loaded;
}

QString MobiPlugin::version() const
{
  return m_version;
}

int MobiPlugin::majorVersion() const
{
  return m_major_version;
}

int MobiPlugin::minorVersion() const
{
  return m_minor_version;
}

int MobiPlugin::buildVersion() const
{
...
QString MobiPlugin::fileFilter()
{
  return m_file_filter;
}

QString MobiPlugin::fileDescription()
{
