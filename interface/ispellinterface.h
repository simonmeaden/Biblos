 ...
 */
class INTERFACESHARED_EXPORT ISpellInterface : public IPluginInterface {
public:
  ...
  virtual QStringList
  compatibleLanguageCodes(QString language_code = QString()) = 0;
...
#define SpellInterface_iid "uk.org.smelecomp.SpellInterface/0.1.0"
