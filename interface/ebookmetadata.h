...
public:
  ...
  void parseMetadata(QDomNodeList metadata_node_list);
...
protected:
  ...
  void parseRefineMetas(QDomElement& metadata_element, QDomNode& node,
                        QDomNamedNodeMap& node_map);
  void parseTitleDateRefines(Title shared_title,
  ...
  void parseCreatorContributorRefines(Creator shared_creator,
                                      ...
                                      QDomNamedNodeMap node_map);
  void parseTitleRefines(QString id, QDomElement metadata_element,
                         QDomNamedNodeMap node_map);
