...
void MainWindow::winFullscreen()
{
    m_wincentre->setEnabled(false);
}

void MainWindow::winMaximise()
{
    m_wincentre->setEnabled(false);
}

void MainWindow::winMinimise()
{
...
//                ISpellInterface *spellinterface = dynamic_cast<ISpellInterface *>(iebook);
//                if (spellinterface) {
//                    m_spellchecker_plugins.insert(name, spellinterface);
//                }
