...
const QString QEPubContainer::METADATA_FOLDER = "META-INF";
const QString QEPubContainer::MIMETYPE_FILE = "mimetype";
const QString QEPubContainer::CONTAINER_FILE = "META-INF/container.xml";
const QString QEPubContainer::TOC_FILE = "toc.ncx";

QEPubContainer::QEPubContainer(QObject* parent)
  : QObject(parent)
  , m_archive(Q_NULLPTR)
  , m_toc(new EPubToc())
{}

QEPubContainer::~QEPubContainer() {}

bool
QEPubContainer::openFile(const QString path)
{
...
QEPubContainer::zipFile(const QString& path)
{
...
QImage
QEPubContainer::image(const QString& id)
{
...
QString
QEPubContainer::metadata(const QString& key)
{
  return m_metadata.value(key);
}

void
QEPubContainer::setMetadata(const QString& key, const QString& value)
{
...
bool
QEPubContainer::parseMimetype(QStringList& files)
{
...
bool
QEPubContainer::parseContainer(QStringList& files)
{
...
bool
QEPubContainer::parseContentFile(const QString filepath)
{
...
bool
QEPubContainer::parseToc(QStringList& files)
{
...
bool
QEPubContainer::parseMetadataItem(const QDomNode& metadataNode)
{
...
bool
QEPubContainer::parseManifestItem(const QDomNode& manifestNode,
...
bool
QEPubContainer::parseSpineItem(const QDomNode& spineNode)
{
...
bool
QEPubContainer::parseGuideItem(const QDomNode& guideItem)
{
